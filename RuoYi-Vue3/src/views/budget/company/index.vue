<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="请求方法 1 post 2 get" prop="method">
        <el-input
          v-model="queryParams.method"
          placeholder="请输入请求方法 1 post 2 get"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="超时时间 (例如650ms)" prop="timeout">
        <el-input
          v-model="queryParams.timeout"
          placeholder="请输入超时时间 (例如650ms)"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="companyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="请求方法 1 post 2 get" align="center" prop="method" />
      <el-table-column label="超时时间 (例如650ms)" align="center" prop="timeout" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="companyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="请求方法 1 post 2 get" prop="method">
          <el-input v-model="form.method" placeholder="请输入请求方法 1 post 2 get" />
        </el-form-item>
        <el-form-item label="超时时间 (例如650ms)" prop="timeout">
          <el-input v-model="form.timeout" placeholder="请输入超时时间 (例如650ms)" />
        </el-form-item>
...
const data = reactive({
  ...
  rules: {
    ...
    method: [
      { required: true, message: "请求方法 1 post 2 get不能为空", trigger: "blur" }
    ],
  }
})
