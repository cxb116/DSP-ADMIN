  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="统一社会信用代码" prop="mediaCompanyCode">
        <el-input
          v-model="queryParams.mediaCompanyCode"
      ...
      <el-form-item label="营业执照照片" prop="mediaCompanyLicense">
        <el-input
          v-model="queryParams.mediaCompanyLicense"
    ...
    <el-table v-loading="loading" :data="mediaList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="统一社会信用代码" align="center" prop="mediaCompanyCode" />
      <el-table-column label="营业执照照片" align="center" prop="mediaCompanyLicense" />
