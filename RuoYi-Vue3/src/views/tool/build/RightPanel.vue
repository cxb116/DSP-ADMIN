...
<!--              <el-radio-button value="large" value="较大" />-->
<!--              <el-radio-button value="default" value="默认" />-->
<!--              <el-radio-button value="small" value="较小" />-->
<!--            </el-radio-group>-->
            <el-radio-group v-model="formConf.size">
...
<!--              <el-radio-button value="left" value="左对齐" />-->
<!--              <el-radio-button value="right" value="右对齐" />-->
<!--              <el-radio-button value="top" value="顶部对齐" />-->
              <el-radio-group v-model="formConf.labelPosition">
